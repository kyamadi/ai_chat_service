...
const Chat = () => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            setMessages([...messages, { sender: 'user', content: newMessage.trim() }, { sender: 'ai', content: response.data.ai_response }]);
            setNewMessage('');
        } catch (error) {
                    ...
                    {messages.map((message, index) => (
                        ...
                        >
                            <Avatar
                                ...
                                src={message.sender === 'user' ? '/user-avatar.jpg' : '/ai-avatar.png'}
                                alt={message.sender}
                            />
                            <Box
                                sx={{
